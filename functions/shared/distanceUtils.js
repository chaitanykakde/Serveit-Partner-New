 ...
 */
async function getRoadDistances(apiKey, origin, destinations) {
  if (!apiKey) {
  ...
  const url = `https://maps.googleapis.com/maps/api/distancematrix/json?origins=${origin.lat},${origin.lng}&destinations=${destinationString}&key=${apiKey}&units=metric&mode=driving`;
